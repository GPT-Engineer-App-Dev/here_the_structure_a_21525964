  ...
  return (
    <Container maxW='container.xl' p={0}>
      <VStack w='full' h='100vh' p={10} spacing={10} alignItems='flex-start'>
        ...
        <Heading size='md'>Unsere Geschichte</Heading>
        ...
        <Heading size='md'>Unsere Mission</Heading>
        ...
        <Heading size='md'>Unsere Werte</Heading>
        <Text>Unsere Kernwerte: Transparenz, Vertrauen, Innovation</Text>
        <Heading size='md'>Unser Team</Heading>
        ...
        <Heading size='md'>Warum ProBau wählen?</Heading>
